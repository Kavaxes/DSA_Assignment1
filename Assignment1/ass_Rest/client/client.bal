...
public function main() returns error? {
    ...
    string action = io:readln("Do you want to retrieve, add, update or delete a program?: ");
    
    if(action == "retrieve"){
         // Ask the user if they want to retrieve all programs or a specific one
    string choice = io:readln("Do you want to retrieve 1.All programs or 2.A Specific program or 3.Programs up for review?: ");
    
    if (choice == "2") {
        string choice_2 = io:readln("Do you want to retrieve by Program code, Faculty, Department or by Registration date?:");

        if(choice_2 == "Program code") {
